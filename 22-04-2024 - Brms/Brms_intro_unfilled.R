...
#run the model
mod_lepiphylo <- brm(...
                   data2 = list(vcv = lepi_cov),   #data 2 argument allows us to pass the phylogenetic information that is not included in the mani dataset 'lepi'
                   iter = 2000,
                   chains = 4,
                   cores = 2)
...
#####################################
# Extra on centering your variables #
#####################################
